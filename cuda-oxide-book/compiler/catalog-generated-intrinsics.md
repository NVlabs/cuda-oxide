...
- `schema` identifies the serialized catalog format expected by the generator.
...
cuda-intrinsics-gen probe --all --skip-terminal
...
```text
crates/cuda-intrinsics-gen/src/model.rs
crates/cuda-intrinsics-gen/src/resolve.rs
crates/cuda-intrinsics-gen/src/render.rs
```
