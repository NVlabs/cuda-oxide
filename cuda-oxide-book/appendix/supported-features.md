...
| Warpgroup MMA (`wgmma`) | **Partial** | Hopper `sm_90a`: descriptors, fence/commit/wait, and F32 accumulation. Canonical linear full drain supports BF16/F16 `m64n64k16`, TF32 `m64n64k8`, E4M3 × E4M3 `m64n64k32` (fixed TN), and BF16 `m64n128k16`. Counted K-loops support BF16/F16 m64n64; partial-wait pipelines support BF16 m64n64 only. E4M3 has no pointer fallback, counted-loop, or partial-wait lowering. |
