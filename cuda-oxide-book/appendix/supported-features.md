...
| Local Clean | **Full** | `cargo oxide clean` removes project-local `target/` directories and generated PTX/LL/LTOIR artifacts (not the shared `~/.cargo/cuda-oxide/` cache). |
