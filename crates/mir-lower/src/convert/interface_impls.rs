...
use dialect_nvvm::ops::{
    ...
    BlackBoxOp, Tcgen05StoreWaitOp, ThreadfenceBlockOp, ThreadfenceOp, ThreadfenceSystemOp, TrapOp,
...
#[op_interface_impl]
impl MirToLlvmConversion for BlackBoxOp {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::debug::convert_black_box(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
