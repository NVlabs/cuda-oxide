...
fn launch_contract_types_are_resolved_semantically() {
    ...
    t.pass("tests/pass/kernel_scope_api.rs");
    ...
    t.compile_fail("tests/compile_fail/index_1d32_requires_contract.rs");
    t.compile_fail("tests/compile_fail/index_1d32_requires_u32_coordinates.rs");
    t.compile_fail("tests/compile_fail/index_1d32_requires_1d_domain.rs");
    t.compile_fail("tests/compile_fail/index_1d32_marker_spoof_requires_unsafe.rs");
    t.compile_fail("tests/compile_fail/index_1d32_generic_helper_requires_entry_scope.rs");
    t.compile_fail("tests/compile_fail/kernel_scope_duplicate.rs");
    t.compile_fail("tests/compile_fail/kernel_scope_unknown_argument.rs");
    t.compile_fail("tests/compile_fail/kernel_scope_parameter_collision.rs");
}
